...
class MultiHeadProjection(nn.Module):
    ...
    def _split_heads(self, tensor):
        ...
        batch_size, tensorlen = tensor.shape[0], tensor.shape[1] # tensorlen = sequence length (?)
        ...
        tensor = tensor.transpose(dim0=1, dim1=2)
        return tensor
        ##########################################################################################
    ...
    def _combine_heads(self, tensor):
        ...
        tensor = tensor.transpose(dim0=2, dim1=1)
